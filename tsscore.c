...
Datum ts_score_wtt(PG_FUNCTION_ARGS);
Datum ts_score_wttf(PG_FUNCTION_ARGS);
Datum ts_score_tt(PG_FUNCTION_ARGS);
Datum ts_score_ttf(PG_FUNCTION_ARGS);

PG_FUNCTION_INFO_V1(ts_score_wtt);
PG_FUNCTION_INFO_V1(ts_score_wttf);
PG_FUNCTION_INFO_V1(ts_score_tt);
PG_FUNCTION_INFO_V1(ts_score_ttf);
...
Datum
ts_score_wttf(PG_FUNCTION_ARGS)
{
	...
	res = calc_score(getWeights(win), txt, query, method);
...
ts_score_wtt(PG_FUNCTION_ARGS)
{
	...
	res = calc_score(getWeights(win), txt, query, DEF_NORM_METHOD);
...
ts_score_ttf(PG_FUNCTION_ARGS)
{
	...
	res = calc_score(getWeights(NULL), txt, query, method);
...
Datum
ts_score_tt(PG_FUNCTION_ARGS)
{
	TSVector	txt = PG_GETARG_TSVECTOR(0);
	TSQuery		query = PG_GETARG_TSQUERY(1);
	float		res;

	res = calc_score(getWeights(NULL), txt, query, DEF_NORM_METHOD);
